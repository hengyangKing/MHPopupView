...
typedef void(^MMSheetViewCancelButtonClickBlock)(UIView *popView, BOOL isFinish);
@interface MMSheetView : MMPopupView

- (instancetype) initWithTitle:(NSString*)title
                         items:(NSArray*)items;
@property(nonatomic,copy)MMSheetViewCancelButtonClickBlock cancelButtonClickBlock;
